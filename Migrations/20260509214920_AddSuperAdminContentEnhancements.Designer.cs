...
namespace AIInsights.Migrations
{
    ...
    [Migration("20260509214920_AddSuperAdminContentEnhancements")]
    partial class AddSuperAdminContentEnhancements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AIInsights.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("IsSubscribedToAnnouncements")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("AIInsights.Models.BlogAnnouncementEmailLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BlogId", "SubscriberEmail")
                        .IsUnique();

                    b.ToTable("BlogAnnouncementEmailLogs");
                });

            modelBuilder.Entity("AIInsights.Models.BlogImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AIInsights.Models.BlogPost", b =>
                {
                    ...
                    b.Property<DateTime?>("AnnouncementQueuedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("IsFeatureAnnouncement")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("SendToAllSubscribers")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AIInsights.Models.BlogSubscription", b =>
                {
                    b.Property<int>("BlogId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("BlogId", "SubscriptionId");
            ...
            modelBuilder.Entity("AIInsights.Models.Datasource", b =>
                {
                    ...
                    b.Property<string>("TransformToml")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AIInsights.Models.DocumentImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AIInsights.Models.Organization", b =>
                {
                    ...
                    b.Property<int>("PurchasedEnterpriseLicenses")
                        .HasColumnType("int");

                    b.Property<int>("PurchasedLicenses")
                        .HasColumnType("int");

                    b.Property<int>("PurchasedProfessionalLicenses")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AIInsights.Models.OrganizationBackupAudit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OrganizationBackupAudits");
                });
            ...
            modelBuilder.Entity("AIInsights.Models.SupportTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AIInsights.Models.TransformDraft", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DatasourceGuidsCsv")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TomlDefinition")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("TransformDrafts");
                });

            modelBuilder.Entity("AIInsights.Models.TransformRunAudit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("InputRowCount")
                        .HasColumnType("int");

                    b.Property<string>("MessagesJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("OutputRowCount")
                        .HasColumnType("int");

                    b.Property<string>("RunGuid")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<int?>("TransformDraftId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TransformDraftId");

                    b.ToTable("TransformRunAudits");
                });

            modelBuilder.Entity("AIInsights.Models.TransformSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TransformDraftId", "DatasourceId", "Alias")
                        .IsUnique();

                    b.ToTable("TransformSources");
                });

            modelBuilder.Entity("AIInsights.Models.TransformStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TransformDraftId", "SortOrder");
            ...
            modelBuilder.Entity("AIInsights.Models.BlogAnnouncementEmailLog", b =>
                {
                    b.HasOne("AIInsights.Models.BlogPost", "Blog")
                        .WithMany("AnnouncementEmailLogs")
            ...
            modelBuilder.Entity("AIInsights.Models.DocumentImage", b =>
                {
                    b.HasOne("AIInsights.Models.DocArticle", "Document")
            ...
            modelBuilder.Entity("AIInsights.Models.TransformRunAudit", b =>
                {
                    ...
                    b.HasOne("AIInsights.Models.TransformDraft", "TransformDraft")
                        .WithMany()
                        .HasForeignKey("TransformDraftId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Datasource");

                    b.Navigation("TransformDraft");
                });
            ...
            modelBuilder.Entity("AIInsights.Models.BlogPost", b =>
                {
                    b.Navigation("AnnouncementEmailLogs");
