        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GeneratedQuery = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PinnedResults", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PageUrl = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    RobotsDirective = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StructuredData = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SitemapPriority = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SitemapChangeFreq = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeoEntries", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasUsedTrial = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedTables = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    XmlaEndpoint = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MicrosoftAccountTenantId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrganizationId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkspaceMemories_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatasourceId = table.Column<int>(type: "int", nullable: true),
                    AgentId = table.Column<int>(type: "int", nullable: true),
                    ChartIds = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Datasources_WorkspaceId",
                table: "Datasources",
                column: "WorkspaceId");

            migrationBuilder.CreateIndex(
                name: "IX_Reports_AgentId",
                table: "Reports",
                column: "AgentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TokenUsages_OrganizationId",
                table: "TokenUsages",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkspaceMemories_WorkspaceId",
